...
class LoginPage extends StatelessWidget {
                  ...
                  builder: (loginPageContext, loginPageState) {
                    return TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: AppStyles.labelTextStyle(),
                        filled: true,
                        suffixIcon: BlocBuilder<LoginPageCubit, LoginPageState>(
                ...
                BlocBuilder<LoginPageCubit, LoginPageState>(
                  builder: (loginContext, loginState) {
                    return loginState.status != const ScreenStatus.pure()
                        ...
                        : ElevatedButton(
                            onPressed: () async =>
                                await _login(loginContext, loginPageState),
  ...
  Future<void> _login(
      BuildContext loginContext, LoginPageState loginPageState) async {
    await loginContext
        .read<LoginPageCubit>()
        .login(
