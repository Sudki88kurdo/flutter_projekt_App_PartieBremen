...
class ProfilePage extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      ...
                      title: Text('Logout'),
                      onTap: () => _showLogoutDialog(profilePageContext, profilePageState),
                    ),
                    const SizedBox(height: 10.0),
                    ListTile(
                      leading: Icon(Icons.delete),
                      title: Text('Account delete'),
                      onTap: () => _showDeleteAccountDialog(profilePageContext, profilePageState),
                    ),
                  ],
                ),
              ),
  ...
  void _showLogoutDialog(BuildContext profileContext, ProfilePageState profilePageState) {
    showDialog(
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.of(dialogContext).pop(); // Schließt den Dialog
                _Logout(profileContext, profilePageState); // Führt den Logout durch
              },
            ),
          ],
        );
  ...
  void _showDeleteAccountDialog(BuildContext profileContext, ProfilePageState profilePageState) {
    showDialog(
      context: profileContext,
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.of(dialogContext).pop(); // Schließt den Dialog
                _DeleteAccount(profileContext, profilePageState); // Führt den Logout durch
              },
            ),
          ],
        );
  ...
  void _Logout(BuildContext profileContext, ProfilePageState profilePageState) async {
  ...
  void _DeleteAccount(BuildContext profileContext, ProfilePageState profilePageState) async {
