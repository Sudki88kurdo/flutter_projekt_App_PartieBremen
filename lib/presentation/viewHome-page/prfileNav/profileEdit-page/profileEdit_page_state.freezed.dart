...
part of 'profileEdit_page_state.dart';
...
class _$ProfileEditPageStateImpl implements _ProfileEditPageState {
  ...
  @override
  String toString() {
    return 'ProfileEditPageState(status: $status, passwordVisible: $passwordVisible, user: $user, pickedDate: $pickedDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, passwordVisible, user, pickedDate);
...
abstract class _ProfileEditPageState implements ProfileEditPageState {
  const factory _ProfileEditPageState(
      ...
      final bool passwordVisible,
      final User? user,
      final DateTime? pickedDate}) = _$ProfileEditPageStateImpl;
